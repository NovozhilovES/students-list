 ...
 * @returns {{ fio: string, dateOfBirth: string, receipt: string, receiptOut: string, faculty: string, age: string, courseNumber: string }} Объект студента
 */
function makeStudentFromData(data) {
    ...
    if (!student.receipt) errors.push({ field: 'receipt', message: 'Не указано начало обучения' });
 ...
 * @returns {{ id: string, fio: string, dateOfBirth: string, receipt: string, receiptOut: string, faculty: string, age: string, courseNumber: string }[]} Массив студентов
 */
 ...
 * @returns {{ id: string, fio: string, dateOfBirth: string, receipt: string, receiptOut: string, faculty: string, age: string, courseNumber: string, createdAt: string, updatedAt: string }} Объект студента
 */
 ...
 * @param {{ fio?: string, dateOfBirth?: string, receipt?: string, receiptOut?: string, faculty?: string, age?: string, courseNumber?: string }} data - Объект с изменяемыми данными
 * @throws {ApiError} Студент с таким ID не найден (statusCode 404)
 * @throws {ApiError} Некорректные данные в аргументе (statusCode 422)
 * @returns {{ id: string, fio: string, dateOfBirth: string, receipt: string, receiptOut: string, faculty: string, age: string, courseNumber: string, createdAt: string, updatedAt: string }} Объект студента
 */
